...
<html>
   <head>
     ...
     <link href="/codeigniter/static/lib/bootstrap/css/bootstrap.min.css" rel="stylesheet">
   </head>
   <body>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          ...
          <ul class="nav navbar-nav navbar-right">
             ...
             <li><a href="/codeigniter/index.php/auth/login">Login</a></li>
             <li><a href="/codeigniter/index.php/auth/register">회원가입</a></li>
            <li class="dropdown">
